...
title = oj.PC.Title("A hello world page",
                    twsty_tags=[bg/pink/"100/20"]
                    )
...
footer = oj.PC.Halign(oj.PC.Prose(text="Thats all folks! Hope you got the broad drift of this framework",
                                  twsty_tags=[mr/st/64, ta.right]
                                  ),
                      "end"
                )
...
tlc = oj.PC.Container(childs = [title,
                                body,
                                footer
                                ],
