...
with oj.MountCtx("example_005"):    
    from . import example_005

with oj.MountCtx("example_006"):    
    from . import example_006

with oj.MountCtx("example_007"):    
    from . import example_007
