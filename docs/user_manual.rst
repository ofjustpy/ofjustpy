...
Intro
~~~~~
Comparison with Justpy
""""""""""""""""""""""
- There is only a single copy of passive and active stuff
...
Url resolver for A/href element tag
"""""""""""""""""""""""""""""""""""
There are two resolver: app.url_path_for and request.url_for.

.. note::
   TODO: fix the text later
...
Avoid runtime lookup for url_for
""""""""""""""""""""""""""""""""
